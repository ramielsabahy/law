          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">{{ $user['enName'] }}</span>
              </a>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="">
              ...
              <span>ادارة المستخدمين</span><i class="fa fa-angle-left pull-left"></i>
              <ul class="treeview-menu">
                <li><a href="{{ route('active') }}"><i class="fa fa-circle-o"></i>المستخدين المفعلين</a></li>
                <li><a href="{{ route('pending') }}"><i class="fa fa-circle-o"></i>المستخدمين الغير مفعلين</a></li>
              </ul>
            </a>
          </li>
          <li class="active treeview">
            <a href="#">
              <i class="fa fa-dashboard"></i> <span>ادارة المقررات</span><i class="fa fa-angle-left pull-left"></i>
              <ul class="treeview-menu">
                <li><a href="{{ route('courses') }}"><i class="fa fa-circle-o"></i>انشاء مقرر جديد</a></li>
                <li><a href="{{ route('showCourse') }}"><i class="fa fa-circle-o"></i>عرض المقررات</a></li>
              </ul>
            </a>
          </li>
          <li class="treeview active">
            <a href="">
              <i class="fa fa-pie-chart"></i>
              <span>ادارة الاختبارات</span><i class="fa fa-angle-left pull-left"></i>
              <ul class="treeview-menu">
                <li><a href="{{ route('tests') }}"><i class="fa fa-circle-o"></i>انشاء اختبار جديد</a></li>
                <li><a href="{{ route('showTest') }}"><i class="fa fa-circle-o"></i>عرض الاختبارات</a></li>
              </ul>
            </a>
          </li>
